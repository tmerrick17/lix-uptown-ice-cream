...
class SBR_Plugin_Insltaller extends ServiceProvider{
    ...
    function install_plugin()
    {
        ...
        $error = esc_html__('Could not install addon. Please download from smashballoon.com and install manually.', 'sbr-customizer');
        ...
        if ($plugin_basename) {
            ...
            wp_send_json_success( [
                ...
                'message' => !is_wp_error($activated) ? __('Plugin Installed & Activated.', 'sbr-customizer') : __('Plugin Installed.', 'sbr-customizer')
            ] );
