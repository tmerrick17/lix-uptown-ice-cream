...
<div class="sb-item-author-date-ctn sb-fs">
	<div class="sb-item-author-ctn sb-relative">
		<?php if ( $this->should_show( 'author', 'image' ) ) : ?>
			<div class="sb-item-author-img sb-relative"><img src="<?php echo esc_html( $this->parser->get_reviewer_avatar_url( $post ) ); ?>" alt="<?php echo esc_html( $this->parser->get_reviewer_name( $post ) ); ?>" /></div>
		<?php endif; ?>
