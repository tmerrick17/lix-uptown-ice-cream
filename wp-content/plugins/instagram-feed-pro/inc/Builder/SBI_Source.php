...
class SBI_Source {
	...
	public static function get_connection_urls( $is_settings = false ) {
		...
		$sw_flag         = ! empty( $_GET['sw-feed'] ) ? '&sw-feed=true' : '';
		...
		$urls['personal'] = 'https://connect.smashballoon.com/auth/ig/?wordpress_user=&v=pro&vn=' . SBIVER . '&sbi_con=' . $nonce . $sw_flag;
		$urls['business'] = 'https://connect.smashballoon.com/auth/ig/?wordpress_user=&v=pro&vn=' . SBIVER . '&sbi_con=' . $nonce . $sw_flag;
