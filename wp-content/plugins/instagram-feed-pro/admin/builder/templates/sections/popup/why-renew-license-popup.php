<div class="sbi-license-why-renew sbc-popup-blur-background sb-fs-boss sbi-fb-center-boss" v-if="viewsActive.whyRenewLicense != null && viewsActive.whyRenewLicense != false">
	<div class="sbc-extensions-popup sbi-fb-popup-inside" v-if="viewsActive.whyRenewLicense != null && viewsActive.whyRenewLicense != false">
        <div class="sbi-fb-popup-cls" @click.prevent.default="activateView('whyRenewLicense')">
