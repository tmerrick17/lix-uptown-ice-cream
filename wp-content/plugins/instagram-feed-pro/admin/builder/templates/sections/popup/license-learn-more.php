<div class="sbi-license-learn-more sbc-popup-blur-background sb-fs-boss sbi-fb-center-boss" v-if="viewsActive.licenseLearnMore != null && viewsActive.licenseLearnMore != false">
	<div class="sbc-extensions-popup sbi-fb-popup-inside" v-if="viewsActive.licenseLearnMore != null && viewsActive.licenseLearnMore != false">
        ...
        <div>
            <div class="sb-llm-header">
                <h2 v-if="sbiLicenseNoticeActive && !sbiLicenseInactiveState">Your Instagram Feed Pro License is expired</h2>
            ...
            <div class="sb-llm-upgrade-benefits">
                ...
                <div class="sb-benefits-block">
                    ...
                    <p>With changes to Instagram and WordPress it's critical to keep your plugin up to date. We regularly provide fixes and enhancements in new releases</p>
                </div>
